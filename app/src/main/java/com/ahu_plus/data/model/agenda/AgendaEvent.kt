package com.ahu_plus.data.model.agenda
 ...
 * 日程页统一展示模型。
 *
 * 由 [com.ahu_plus.data.agenda.AgendaBuilder] 把课表/考试展开成带**具体日历日**
 * 的事件,再与作业([com.ahu_plus.data.model.task.HomeworkRecord])、手动日程
 * ([com.ahu_plus.data.model.task.UserTask]) 合并,按 [date] 分组后交给 UI 渲染。
 *
